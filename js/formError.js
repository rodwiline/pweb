            ...
            var errorDiv =
               $("<div class='validationErrorContainer' style='position:absolute; left:101%; top:-2px; z-index:99999;'>" +
                   "<canvas width='14' height='14' style='position:absolute; left:-3px; top:7px;' />" +
                      "<div class='validationError' style='border:1px solid #fff; border-radius:5px; padding:4px; background-color:#074481; color:#efefef; position:relative; left:8px; padding: 10px 5px; white-space:nowrap;'>" +
                     options.message +
                   "</div>" +
                 "</div>");
